//! complete bindings around the Lua C API version 5.2.4
...
///
/// See https://www.lua.org/manual/5.2/manual.html#lua_Alloc for more details
...
/// See https://www.lua.org/manual/5.2/manual.html#lua_CFunction for the protocol
...
pub const Lua = struct {
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_absindex
    pub fn absIndex(lua: *Lua, index: i32) i32 {
        return c.lua_absindex(lua.state, index);
    }

    /// Performs an arithmetic operation over the value(s) at the top of the stack,
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_atpanic
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_call
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_callk
    pub fn callCont(lua: *Lua, num_args: i32, num_results: i32, ctx: i32, k: ?CFn) void {
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_checkstack
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_close
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_concat
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_copy
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_createtable
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_dump
    pub fn dump(lua: *Lua, writer: CWriterFn, data: *anyopaque) !void {
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_error
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_gc
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_getfield
    pub fn getField(lua: *Lua, index: i32, key: [:0]const u8) void {
        c.lua_getfield(lua.state, index, key.ptr);
    }

    /// Pushes onto the stack the value of the global name
    /// See https://www.lua.org/manual/5.2/manual.html#lua_getglobal
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_getuservalue
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_getmetatable
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_gettable
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_gettop
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_insert
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_isboolean
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_iscfunction
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_isfunction
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_islightuserdata
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_isnoneornil
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_isnumber
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_isstring
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_istable
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_isthread
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_isuserdata
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_len
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_load
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_newtable
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_newthread
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_pcall
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_pcallk
    pub fn protectedCallCont(lua: *Lua, num_args: i32, num_results: i32, msg_handler: i32, ctx: i32, k: CFn) !void {
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_pop
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_pushcclosure
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_pushcfunction
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_pushfstring
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_pushglobaltable
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_pushinteger
    pub fn pushInteger(lua: *Lua, n: Integer) void {
        c.lua_pushinteger(lua.state, n);
    }

    /// Pushes a light userdata onto the stack
    /// See https://www.lua.org/manual/5.2/manual.html#lua_lightuserdata
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_pushstring
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_pushthread
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_pushvalue
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_rawequal
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_rawget
    pub fn rawGetTable(lua: *Lua, index: i32) void {
        c.lua_rawget(lua.state, index);
    }

    /// Pushes onto the stack the value t[n], where `t` is the table at the given `index`
    /// Returns the `LuaType` of the pushed value
    /// See https://www.lua.org/manual/5.2/manual.html#lua_rawgeti
    pub fn rawGetIndex(lua: *Lua, index: i32, n: i32) void {
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_rawgetp
    pub fn rawGetPtr(lua: *Lua, index: i32, p: *const anyopaque) void {
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_rawlen
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_rawset
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_rawseti
    ...
    /// Pops the value from the stack. Does not use __newindex metavalue
    /// See https://www.lua.org/manual/5.2/manual.html#lua_rawsetp
    pub fn rawSetPtr(lua: *Lua, index: i32, p: *const anyopaque) void {
        c.lua_rawsetp(lua.state, index, p);
    }

    /// Sets the C function f as the new value of global name
    /// See https://www.lua.org/manual/5.2/manual.html#lua_register
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_remove
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_replace
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_resume
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_setallocf
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_setfield
    pub fn setField(lua: *Lua, index: i32, k: [:0]const u8) void {
        c.lua_setfield(lua.state, index, k.ptr);
    }

    /// Pops a value from the stack and sets it as the new value of global `name`
    /// See https://www.lua.org/manual/5.2/manual.html#lua_setglobal
    pub fn setGlobal(lua: *Lua, name: [:0]const u8) void {
        c.lua_setglobal(lua.state, name.ptr);
    }

    /// Pops a value from the stack and sets it as the user value associated to the full userdata at the given index
    /// Returns an error if the userdata does not have that value
    /// See https://www.lua.org/manual/5.2/manual.html#lua_setuservalue
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_setmetatable
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_settable
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_settop
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_toboolean
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_tocfunction
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_tointegerx
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_tolstring
    ...
    /// Returns an error if the conversion failed
    /// See https://www.lua.org/manual/5.2/manual.html#lua_tonumberx
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_topointer
    ...
    /// Returns an error if the conversion failed
    /// If the value was a number the actual value in the stack will be changed to a string
    /// See https://www.lua.org/manual/5.2/manual.html#lua_tostring
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_tothread
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_upvalueindex
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_version
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_xmove
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_yield
    ...
    /// This function never returns
    /// See https://www.lua.org/manual/5.2/manual.html#lua_yieldk
    pub fn yieldCont(lua: *Lua, num_results: i32, ctx: i32, k: CFn) noreturn {
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_gethook
    pub fn getHook(lua: *Lua) ?CHookFn {
        return c.lua_gethook(lua.state);
    }

    /// Returns the current hook count
    /// See https://www.lua.org/manual/5.2/manual.html#lua_gethookcount
    pub fn getHookCount(lua: *Lua) i32 {
        return c.lua_gethookcount(lua.state);
    }

    /// Returns the current hook mask
    /// See https://www.lua.org/manual/5.2/manual.html#lua_gethookmask
    ...
    /// are still handled
    /// See https://www.lua.org/manual/5.2/manual.html#lua_getinfo
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_getstack
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_getupvalue
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_sethook
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_setupvalue
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_upvalueid
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#lua_upvaluejoin
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#luaL_argerror
    ...
    /// Calls a metamethod
    /// See https://www.lua.org/manual/5.2/manual.html#luaL_callmeta
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#luaL_checkany
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#luaL_checkinteger
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#luaL_checklstring
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#luaL_checknumber
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#luaL_checkoption
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#luaL_checkstack
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#luaL_checkstring
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#luaL_checkversion
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#luaL_dostring
    ...
    /// Raises an error
    /// See https://www.lua.org/manual/5.2/manual.html#luaL_error
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#luaL_execresult
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#luaL_fileresult
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#luaL_getmetatable
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#luaL_getsubtable
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#luaL_gsub
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#luaL_len
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#luaL_loadstring
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#luaL_newlib
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#luaL_newmetatable
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#luaL_newstate
    ...
    /// If the argument is absent or nil returns `default`
    /// See https://www.lua.org/manual/5.2/manual.html#luaL_optinteger
    ...
    /// If the argument is absent or nil returns `default`
    /// See https://www.lua.org/manual/5.2/manual.html#luaL_optlstring
    ...
    /// If the argument is absent or nil returns `default`
    /// See https://www.lua.org/manual/5.2/manual.html#luaL_optnumber
    ...
    /// Pops the object
    /// See https://www.lua.org/manual/5.2/manual.html#luaL_ref
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#luaL_setfuncs
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#luaL_setmetatable
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#luaL_traceback
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#luaL_typename
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#luaL_unref
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#luaL_where
    ...
    pub fn open(lua: *Lua, libs: Libs) void {
        ...
        if (libs.bit) lua.requireF(c.LUA_BITLIBNAME, c.luaopen_bit32, true);
    }
...
pub const Buffer = struct {
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#luaL_buffinit
    pub fn init(buf: *Buffer, lua: Lua) void {
        c.luaL_buffinit(lua.state, &buf.b);
    }

    /// Initialize a Lua string buffer with an initial size
    /// See https://www.lua.org/manual/5.2/manual.html#luaL_buffinitsize
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#luaL_addchar
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#luaL_addlstring
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#luaL_addsize
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#luaL_addstring
    ...
    /// Pops the value
    /// See https://www.lua.org/manual/5.2/manual.html#luaL_addvalue
    pub fn addValue(buf: *Buffer) void {
        c.luaL_addvalue(&buf.b);
    }

    /// Equivalent to prepSize with a buffer size of Buffer.buffer_size
    /// See https://www.lua.org/manual/5.2/manual.html#luaL_prepbuffer
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#luaL_prepbuffsize
    ...
    /// See https://www.lua.org/manual/5.2/manual.html#luaL_pushresult
